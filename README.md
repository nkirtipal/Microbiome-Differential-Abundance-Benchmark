...
**Results**  
Averaged across all 8 scenarios:  
| | | | | |  
|-|-|-|-|-|  
...
   
All three claim to control false discoveries at 5%. Only one actually does.  
DESeq2 and ANCOM-BC2 both find more true positives, but most of what they report is  
   
 wrong — DESeq2 is wrong about 65% of the time, ANCOM-BC2 about 78%, despite both  
   
 promising 5%. That's the same failure Hawinkel et al. (2019, *Briefings in*  
 *  
